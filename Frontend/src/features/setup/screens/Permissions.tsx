...
import {
  isDeliveryNotificationAccessEnabled as isNotificationAccessGranted,
  openDeliveryNotificationAccessSettings as openNotificationAccessSettings,
} from '../../../services/notifications/deliveryNotificationAccess';

const isDeliveryNotificationSupported = Platform.OS === 'android';
