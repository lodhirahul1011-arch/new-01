    ...
    >
      ...
      <View style={[styles.container, { paddingTop: s(HEADER_TOP) }]}>
        ...
        {moreOptionsOpen && (
          ...
          // only option Figma shows here; the backend has no Whatsapp OTP
          // integration at all, so it's rendered like the Google/Apple
          // buttons on Login — visibly present, but "coming soon" on tap
          // rather than a dead/missing control.
          <View style={styles.moreOptionsBackdrop}>
            ...
            >
              ...
              <Pressable
                onPress={() => setWhatsappNotice('Whatsapp OTP delivery is coming soon.')}
                style={[
                  styles.whatsappRow,
