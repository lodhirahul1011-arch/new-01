...
// Read through the shared hook rather than a module-scope Dimensions.get, which
// is captured once at import and never updates on rotation or in split-screen.
const LOGO = { width: 184, height: 56 };
